...
const style = `
  ...
  /* ══════════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════════
     Таблица уже была готова к мобиле: .mt-wrap{overflow-x:auto} —
     горизонтальный скролл вместо обрезки колонок, сортировка по
     заголовкам уже на onClick (тач-совместимо). Правим только
     тач-таргет кнопки действия.
  */
  @media (max-width: 1024px) {
    .mt-arb-btn { padding: 9px 14px; }
  }
`
