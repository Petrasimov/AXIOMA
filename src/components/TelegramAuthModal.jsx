...
const style = `
    ...
    /* ══════════════════════════════════════════════════════════════
       ...
       ══════════════════════════════════════════════════════════════
       Модалка уже была построена мобильно: max-width: calc(100vw - 32px)
       не даёт ей упереться в края экрана, кнопки уже 48px высотой —
       полноценный тач-таргет. Уменьшаем только внутренние отступы
       на совсем узких экранах, чтобы осталось больше места контенту.
       Виджет Telegram-логина рендерится их собственным скриптом —
       управлять его шириной с нашей стороны нельзя.
    */
    ...
    @media (max-width: 480px) {
        .tg-modal { padding: 28px 22px 24px; }
